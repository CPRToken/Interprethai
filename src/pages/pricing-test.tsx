...
import { getTestPriceId } from 'src/utils/getTestPriceId';




const PricingTestSection: FC = () => {
  ...
  const handleCheckout = (selectedPlan: string) => {
    const priceId = getTestPriceId(selectedPlan);
    const userId = uuidv4();
              ...
              <Grid xs={12} md={6}>
                ...
                >
                  <PricingPlan
                    ...
                    priceId={isYearly ? t(tokens.form.priceTestBasicYearly) : t(tokens.form.priceTestBasic)}
                    sx={{
                      height: '100%',
                      maxWidth: 460,
                      mx: 'auto',
              ...
              <Grid xs={12} md={6}>
                ...
                >
                  <PricingPlan
                    ...
                    priceId={isYearly ? t(tokens.form.priceTestPremiumYearly) : t(tokens.form.priceTestPremium)}
                    sx={{
                      height: '100%',
                      maxWidth: 460,
                      mx: 'auto',
...
export default PricingTestSection;
